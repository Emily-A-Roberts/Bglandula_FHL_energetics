---
title: "FHL_Bglandula_model_setup"
format: html
editor: visual
---
...
If the file is opened within the .Rproj file, then the function here::here() will find the correct data file regardless of where this is being run. An alternative option is to set the root drive using knitr, but this does not need to be done if running the scripts within the Bglandula_FHL_energetics.Rproj project.
